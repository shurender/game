...
def calculate_damage(attacker: Creature, defender: Creature, move: Move) -> Tuple[int, float]:
    """Calculate the damage dealt by a move.
    
    Returns:
        A tuple of (damage_amount, type_multiplier)
    """
    ...
    # Standard RPG damage formula (simplified Pokémon style)
    ...
    final_damage = math.floor(base_damage * stab * effectiveness * variance)
